...
tabL, tab1, tabP, tab2, tab3, tab4 = st.tabs(
    ["🛰 Live Ops", "⚡ Live Triage", "📋 Plan Event", "🗺 Hotspot Map",
     "📈 Forecast & Staffing", "🧪 Model Card"])
...
with tab1:
    ...
    rec = core.recommend_deployment(pred, corr)
    ...
    with right:
        ...
        <div class="ticket" style="--lv:{lv_color}">
          ...
          <div class="row"><span class="k">Predicted clearance time</span>
            <span class="v">{pred['duration_min']:.0f} min · {pred['clearance_band']}</span></div>
...
median error and show a clearance *band* rather than overclaiming a point estimate.
""")
